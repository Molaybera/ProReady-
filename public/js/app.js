  ...
  try {
    ...
    const html = videos.map(v => `
      <div class="video-card">
        <video src="${v.videoPath}" controls class="video-player"></video>
...
window.filterNetwork = function() {
  ...
  container.innerHTML = filtered.map(v => `
    <div class="video-card coach-video-card" onclick="openPlayerProfile('${v.uploader._id}', '${v.videoPath}', '${v.title}')">
      <video src="${v.videoPath}" class="video-player" muted onmouseover="this.play()" onmouseout="this.pause()"></video>
      <div class="video-info">
        <div class="video-title">${v.title}</div>
